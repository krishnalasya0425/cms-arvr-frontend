      ...
      {user?.role === "admin" ? (
        <main className="flex-grow p-6">
          <div className="flex gap-4 mb-6">
            <button
              className={`px-4 py-2 rounded ${activeTab === "projects" ? "bg-green-700 text-white" : "bg-green-200"}`}
              onClick={() => setActiveTab("projects")}
            >
              Projects
            </button>
            <button
              className={`px-4 py-2 rounded ${activeTab === "createProject" ? "bg-green-700 text-white" : "bg-green-200"}`}
              onClick={() => setActiveTab("createProject")}
            >
              Create Project
            </button>
            <button
              className={`px-4 py-2 rounded ${activeTab === "users" ? "bg-green-700 text-white" : "bg-green-200"}`}
              onClick={() => setActiveTab("users")}
            >
              Users
            </button>
