...
//         if (gameView) mainWindow.removeBrowserView(gameView);
...
//         gameView.setBounds({ x: 300, y: 0, width: 900, height: 800 }); 
//         gameView.webContents.loadFile(path.join(folderPath, "index.html"));
